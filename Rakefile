...
desc 'Generate documentation for the bancomer_integration extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'BancomerIntegrationExtension'
...
desc 'Test the bancomer_integration extension.'
...
namespace :test do
  desc 'Functional test the bancomer_integration extension.'
  ...
  desc 'Unit test the bancomer_integration extension.'
